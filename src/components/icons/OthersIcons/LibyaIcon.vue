<template>
  ...
  >
    ...
    ></path>
    <path fill="#c94747" d="M57.4 16C52.1 7.6 42.7 2 32 2S11.9 7.6 6.6 16z"></path>
    <path fill="#83bf4f" d="M6.6 48c5.3 8.4 14.7 14 25.4 14s20.1-5.6 25.4-14z"></path>
    <g fill="#fff">
      <path
        d="M38.2 36.7v-3.6L34.7 32l3.5-1.1v-3.6l2.2 2.9l3.6-1.1l-2.2 2.9l2.2 2.9l-3.6-1.1z"
      ></path>
      <path
