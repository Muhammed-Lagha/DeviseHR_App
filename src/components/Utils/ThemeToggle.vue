<template>
  <div>
    ...
    />
    <label
      class="w-8 h-8 flex items-center justify-center p-1 text-gray-600 dark:text-gray-400 rounded-md focus:outline-none hover:bg-slate-200 dark:hover:bg-[#282828]"
      for="light-switch"
    >
