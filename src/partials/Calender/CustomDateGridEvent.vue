<template>
  <div
    class="custom-date-grid-event bg-white dark:bg-black"
    :style="{
      width: '100%',
      height: '100%',
  ...
  >
    ...
    <span class="bg-white text-gray-200 dark:text-gray-800 dark:bg-slate-800">
      <input v-model="isChecked" type="checkbox" />
      {{ calendarEvent.title }}
    </span>

    <div class="right-arrow dark:bg-black">&rarr;</div>
  </div>
</template>
